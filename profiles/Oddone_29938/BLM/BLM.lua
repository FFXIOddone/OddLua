local profile = {};
profile.OddLuaBuildToken = 'DCE3B7C9B8A412725B24B016ED88F39152CBECFFFEE243D7D1F575F5AB2DAB23';
...
mechanicsSwapPlanner.transitions['Burn'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Head',
            ['itemId'] = 15075,
            ['item'] = 'Sorcerer\'s Petas.',
            ['reason'] = 'pool delta HP-15, MP-2',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'BLM',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-BLM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Snow Ring', 'snow_ring' },
        { 'Sorcerer\'s Belt', 'sorcerers_belt' },
        { 'Sorcerer\'s Gloves', 'sorcerers_gloves' },
        { 'Sorcerer\'s Petas.', 'sorcerers_petas.', 'sorcerers_petasos' },
        { 'Sorcerer\'s Sabots', 'sorcerers_sabots' },
        { 'Sorcerer\'s Tonban', 'sorcerers_tonban' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['BLM'];

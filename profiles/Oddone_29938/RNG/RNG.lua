local profile = {};
profile.OddLuaBuildToken = '261A9C096E4D1BC88131384DF2E393AF967F04B1D7C96AF8C31F4405C73B94FC';
...
local setIntents = {
    ...
    WS_Flaming_Arrow = 'Weaponskill',
    WSAcc_Flaming_Arrow = 'WeaponSkillAccuracy',
    DivineDamage = 'Idle',
...
profile.ReconciliationNameAliases = {
    groups = {
        { 'Artificer\'s Ring', 'artificers_ring' },
        { 'Blank Soulplate', 'blank_soul_plate', 'blank_soulplate' },
        { 'Bronze Axe +1', 'bronze_axe_+1' },
        { 'Bronze Knife', 'bronze_knife' },
        { 'Carpenter\'s Apron', 'carpenters_apron' },
        { 'Carpenter\'s Gloves', 'carpenters_gloves' },
        { 'Chocobo Boots', 'chocobo_boots' },
        { 'Craftmaster\'s Ring', 'craftmasters_ring' },
        { 'Destrier Beret', 'destrier_beret' },
        { 'Field Hose', 'field_hose' },
        { 'Kupo Shield', 'kupo_shield' },
        { 'Kupo Suit', 'kupo_suit' },
        { 'Midras\'s Helm +1', 'midrass_helm_+1' },
        { 'Sprout Beret', 'sprout_beret' },
        { 'Tarutaru Braccae', 'tarutaru_braccae' },
    },
    aliases = {},
};
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['RNG'];

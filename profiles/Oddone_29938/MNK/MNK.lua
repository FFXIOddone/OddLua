local profile = {};
profile.OddLuaBuildToken = 'E4517058915A479FE4B68297C6B1EED4EA3DA8A011931F76F573E8EA34EE3086';
...
local function message(text)
    text = '[Oddone MNK] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'MNK',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-MNK.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',

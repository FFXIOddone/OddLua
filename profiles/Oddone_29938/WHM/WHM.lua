...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['WHM'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Oddone_29938_WHM',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Oddone_29938 WHM';

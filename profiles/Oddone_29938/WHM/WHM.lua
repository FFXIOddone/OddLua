local profile = {};
profile.OddLuaBuildToken = '0F225A8EE972FAC304E5E1ED81801D053820F911BB0EC34D0496EE951EC46CC0';
...
local DEFAULT_PLAYSTYLE = 'Cure';
local STYLE_COMMANDS_TEXT = 'cure|fastcast|idlerefresh|damage';
...
mechanicsSwapPlanner.transitions['Cure'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Legs',
            ['itemId'] = 15119,
            ['item'] = 'Cleric\'s Pantaln.',
            ['reason'] = 'pool delta HP-25, MP-8',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'WHM',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-WHM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Cleric\'s Belt', 'clerics_belt' },
        { 'Cleric\'s Duckbills', 'clerics_duckbills' },
        { 'Cleric\'s Pantaln.', 'clerics_pantaln.', 'clerics_pantaloons' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['WHM'];
...
local function lockstyleCombatSet()
    if not equipNamedSet('TP', true) then
        if not equipNamedSet(setNameFor('Cure'), true) then
...
profile.OnLoad = function()
    ...
    message('Configured default Subjob=SCH. Use /lac fwd subjob for level-37 capabilities.');

local profile = {};
profile.OddLuaBuildToken = 'F014A16FBFB89A911804A8DA2B9475C8D81C59369F70534BE0F3AB481E50E56D';
...
local setIntents = {
    ...
    WS_Smash_Axe = 'Weaponskill',
    WSAcc_Smash_Axe = 'WeaponSkillAccuracy',
    WS_Gale_Axe = 'Weaponskill',
    WSAcc_Gale_Axe = 'WeaponSkillAccuracy',
    WS_Avalanche_Axe = 'Weaponskill',
    WSAcc_Avalanche_Axe = 'WeaponSkillAccuracy',
    WS_Iron_Tempest = 'Weaponskill',
    WSAcc_Iron_Tempest = 'WeaponSkillAccuracy',
    WS_Sturmwind = 'Weaponskill',
    WSAcc_Sturmwind = 'WeaponSkillAccuracy',
    WS_Armor_Break = 'Weaponskill',
    WSAcc_Armor_Break = 'WeaponSkillAccuracy',
    WS_Dark_Harvest = 'Weaponskill',
    WSAcc_Dark_Harvest = 'WeaponSkillAccuracy',
    WS_Shadow_Of_Death = 'Weaponskill',
    WSAcc_Shadow_Of_Death = 'WeaponSkillAccuracy',
    WS_Nightmare_Scythe = 'Weaponskill',
    WSAcc_Nightmare_Scythe = 'WeaponSkillAccuracy',
    WS_Spinning_Scythe = 'Weaponskill',
    WSAcc_Spinning_Scythe = 'WeaponSkillAccuracy',
...
profile.BuffItemOverlays = {
    Playstyle_Survival = {
        ...
        },
        {
            ...
            afterUse = { Feet = 'Mountain Gaiters' },
            item = {
                ['id'] = 15754,
...
local mechanicsSwapPlanner = {
    ...
    ['explicitTransitions'] = {
        ['setmp'] = {
            ['available'] = false,
            ['reason'] = 'ambiguous_idle_pool_equipment',
        },
        ['avoidtick'] = {
            ['available'] = false,
...
mechanicsSwapPlanner.transitions['Damage'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 14782,
            ['item'] = 'Astral Earring',
            ['reason'] = 'pool delta MP-4, CONVHPTOMP+25',
        },
    },
...
mechanicsSwapPlanner.transitions['Survival'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Hands',
            ['itemId'] = 13713,
            ['item'] = 'Carapace Mittens',
            ['reason'] = 'pool delta HP-4, MP-4',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
mechanicsSwapPlanner.transitions['Fencer'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Fencer',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['WS_Burning_Blade'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Body',
            ['itemId'] = 14548,
            ['item'] = 'Phobos\'s Cuirass',
            ['reason'] = 'pool delta HP-10, HPP+1, MP-10',
        },
        {
            ['key'] = 'equip_target',
            ['phase'] = 'equip_target',
    ...
    ['warnings'] = { 'final_hp_pool_lower', 'hp_percent_or_conversion_requires_runtime_probe' },
    ['poolSummaries'] = {
        ['HP'] = {
            ['sourceFlat'] = 8,
            ['targetFlat'] = -6,
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'WAR',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-WAR.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Carapace Mittens', 'carapace_mittens' },
        { 'Carpenter\'s Apron', 'carpenters_apron' },
        { 'Carpenter\'s Gloves', 'carpenters_gloves' },
        { 'Chain Choker', 'chain_choker' },
        { 'Clear Ring', 'clear_ring' },
        { 'Cmb.Cst. Axe', 'cmb.cst._axe', 'combat_casters_axe' },
        { 'Corsette', 'corsette' },
        { 'Cuir Bandana', 'cuir_bandana' },
        { 'Elementium Torque', 'pacifying_chain' },
        { 'Empress Hairpin', 'empress_hairpin' },
        { 'Enyo\'s Gauntlets', 'enyos_gauntlets' },
        { 'Enyo\'s Mask', 'enyos_mask' },
        { 'Flower Necklace', 'flower_necklace' },
        { 'Focus Collar', 'focus_collar' },
        { 'Garnet Ring', 'garnet_ring' },
        { 'Guerilla Gloves', 'guerilla_gloves' },
        { 'Headlong Belt', 'headlong_belt' },
        { 'Huge Moth Axe', 'huge_moth_axe' },
        { 'Kupo Suit', 'kupo_suit' },
        { 'Leaping Boots', 'leaping_boots' },
        { 'Leather Belt', 'leather_belt' },
        { 'Leather Ring', 'leather_ring' },
        { 'Mana Ring', 'mana_ring' },
        { 'Marksman\'s Ring', 'marksmans_ring' },
        { 'Morion Tathlum', 'morion_tathlum' },
        { 'Mountain Gaiters', 'mountain_gaiters' },
        { 'Mythril Earring', 'mythril_earring' },
        { 'Noble\'s Ribbon', 'nobles_ribbon' },
        { 'Pearl Ring', 'pearl_ring' },
        { 'Phobos\'s Cuirass', 'phoboss_cuirass' },
        { 'Ram Mantle', 'ram_mantle' },
        { 'Republic Subligar', 'republic_subligar' },
        { 'Ryl.Sqr. Breeches', 'royal_squires_breeches', 'ryl.sqr._breeches' },
        { 'Ryl.Sqr. Collar', 'royal_squires_collar', 'ryl.sqr._collar' },
        { 'Ryl.Sqr. Mufflers', 'royal_squires_mufflers', 'ryl.sqr._mufflers' },
        { 'Sardonyx Earring', 'sardonyx_earring' },
        { 'Scale Cuisses', 'scale_cuisses' },
        { 'Silver Hairpin', 'silver_hairpin' },
        { 'Sniper\'s Ring', 'snipers_ring' },
        { 'Sprout Beret', 'sprout_beret' },
        { 'Strike Shield', 'strike_shield' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['WAR'];

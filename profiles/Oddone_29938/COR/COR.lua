...
profile.OnLoad = function()
    ...
    message('OddLua dynamic profile loaded for Oddone_29938. Default combat style: ' .. state.Playstyle .. '. Use /lac fwd style rangeddamage|rangedaccuracy|quickdraw|roll.');

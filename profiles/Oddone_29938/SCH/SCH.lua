local profile = {};
profile.OddLuaBuildToken = '59B3AF0A0ACA9ABAFEB0DB77591C83DA9B9D7F1898368B7DABC275240AC26566';
...
mechanicsSwapPlanner.transitions['AlacrityCelerity'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'AlacrityCelerity',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'SCH',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-SCH.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Argute Belt', 'argute_belt' },
        { 'Argute Bracers', 'argute_bracers' },
        { 'Argute Gown', 'argute_gown' },
        { 'Argute Loafers', 'argute_loafers' },
        { 'Argute M.board', 'argute_m.board', 'argute_mortarboard' },
        { 'Argute Pants', 'argute_pants' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['SCH'];

local profile = {};
profile.OddLuaBuildToken = 'E935F3724705DF4F9E6C3842C111FB84CE1D290927B62B9D71854F1A758F3BE7';
...
local STYLE_COMMANDS_TEXT = 'damage|accuracy|waltz|evasion';
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'DNC',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-DNC.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['DNC'];

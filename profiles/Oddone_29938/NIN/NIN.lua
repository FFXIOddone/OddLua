local profile = {};
profile.OddLuaBuildToken = '31B023E13391611B79CD869A31345FE69087D41A2B40685258C3103FAC91FEB8';
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'NIN',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-NIN.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        { 'Archer\'s Ring', 'archers_ring' },
        { 'Beetle Harness', 'beetle_harness' },
        ...
        { 'Ryl.Sqr. Chainmail', 'royal_squires_chainmail', 'ryl.sqr._chainmail' },
        ...
        { 'Sarutobi Kyahan', 'sarutobi_kyahan' },

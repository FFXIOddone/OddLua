local profile = {};
profile.OddLuaBuildToken = '2EA08E60EADCE512F7AA9C71CCB100235D927E2C1CF160B56F75FBACD21E71E7';
...
local setIntents = {
    ...
    WS_Skewer = 'Weaponskill',
    WSAcc_Skewer = 'WeaponSkillAccuracy',
    WS_Wheeling_Thrust = 'Weaponskill',
    WSAcc_Wheeling_Thrust = 'WeaponSkillAccuracy',
...
local DEFAULT_PLAYSTYLE = 'StoreTP';
local STYLE_COMMANDS_TEXT = 'storetp|accuracy|weaponskill|jump';
...
profile.BuffItemOverlays = {
    ...
    IdleCombat = {
        ...
        },
        {
            ...
            afterUse = { Head = 'Conqueror\'s Helm' },
            item = {
                ['id'] = 25679,
                ['name'] = 'Wh. Rarab Cap +1',
                ['effect'] = 'reraise',
...
mechanicsSwapPlanner.transitions['StoreTP'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'StoreTP',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['Jump'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Jump',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['PDT'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 13552,
            ['item'] = 'Serket Ring',
            ['reason'] = 'pool delta CONVHPTOMP+50',
        },
        {
            ['key'] = 'equip_target',
            ['phase'] = 'equip_target',
...
mechanicsSwapPlanner.transitions['Cure'] = {
    ...
    ['warnings'] = { 'hp_percent_or_conversion_requires_runtime_probe', 'mp_percent_or_conversion_requires_runtime_probe' },
    ['poolSummaries'] = {
        ['HP'] = {
            ['sourceFlat'] = 110,
            ['targetFlat'] = 125,
...
mechanicsSwapPlanner.transitions['HighJump'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'HighJump',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['JumpAccuracy'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'JumpAccuracy',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
...
mechanicsSwapPlanner.transitions['HighJumpAccuracy'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'HighJumpAccuracy',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
...
mechanicsSwapPlanner.transitions['WyvernBreath'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WyvernBreath',
    ['actions'] = {
        {
            ['key'] = 'equip_target',
            ['phase'] = 'equip_target',
...
mechanicsSwapPlanner.transitions['WS_Skewer'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WS_Skewer',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['WSAcc_Skewer'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WSAcc_Skewer',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
...
mechanicsSwapPlanner.transitions['WS_Wheeling_Thrust'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WS_Wheeling_Thrust',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
...
mechanicsSwapPlanner.transitions['WSAcc_Wheeling_Thrust'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WSAcc_Wheeling_Thrust',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
...
local weaponSkillRoutes = {
    ...
    ['wheeling_thrust'] = 'WS_Wheeling_Thrust',
};
...
local weaponSkillAccuracyRoutes = {
    ...
    ['wheeling_thrust'] = 'WSAcc_Wheeling_Thrust',
};
...
local function message(text)
    text = '[Oddone DRG] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'DRG',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-DRG.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Conqueror\'s Helm', 'quauhpilli_helm' },
        { 'Corsette', 'corsette' },
        ...
        { 'Dragoon\'s Earring', 'dragoons_earring' },
        ...
        { 'Gnd.Kgt. Lance', 'gnd.kgt._lance', 'grand_knights_lance' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['DRG'];
...
local function lockstyleCombatSet()
    if not equipNamedSet('TP', true) then
        if not equipNamedSet(setNameFor('StoreTP'), true) then
...
profile.OnLoad = function()
    ...
    message('Configured default Subjob=SAM. Use /lac fwd subjob for level-37 capabilities.');

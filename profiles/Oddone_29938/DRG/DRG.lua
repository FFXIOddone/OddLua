...
local STYLE_COMMANDS_TEXT = 'damage|accuracy|weaponskill|jump';
local oddLuaRefresh = {
...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['DRG'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Oddone_29938_DRG',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Oddone_29938 DRG';

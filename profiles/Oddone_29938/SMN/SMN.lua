...
mechanicsSwapPlanner.transitions['Elemental'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 13877,
            ['item'] = 'Zenith Crown +1',
            ['reason'] = 'pool delta HP-50, MP-50, CONVHPTOMP+55',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['SMN'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Oddone_29938_SMN',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Oddone_29938 SMN';

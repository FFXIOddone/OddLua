local profile = {};
profile.OddLuaBuildToken = '16A681967BDD16320FC7A9CD7E319E01B15E97FDD95CFC0406AE31EAB4172D44';
...
local setIntents = {
    ...
    Playstyle_SummoningMagic = 'Summoning',
...
local DEFAULT_PLAYSTYLE = 'AvatarPerp';
local STYLE_COMMANDS_TEXT = 'avatarperp|bloodpact|summoningmagic|idlerefresh';
    ...
    Playstyle_AvatarPerp = {
        {
            ...
            afterUse = { Feet = 'Nashira Crackows' },
            item = {
                ['id'] = 15754,
...
mechanicsSwapPlanner.transitions['AvatarPerp'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'AvatarPerp',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['BloodPact'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'BloodPact',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['SummoningMagic'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'SummoningMagic',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['Summoning'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Summoning',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['BloodPactRage'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'BloodPactRage',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['BloodPactWard'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'BloodPactWard',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.skippedTransitions['Avatar_Carbuncle'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Fenrir'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Ifrit'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Titan'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Leviathan'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Garuda'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Shiva'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Ramuh'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Diabolos'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Cait_Sith'] = 'runtime_overlay';
mechanicsSwapPlanner.skippedTransitions['Avatar_Siren'] = 'runtime_overlay';
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'SMN',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-SMN.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Carbuncle Mitts', 'carbuncle_mitts' },
        ...
        { 'Enlil\'s Gambison', 'enlils_gambison' },
        { 'Erudite Cap', 'buremte_hat' },
        { 'Evoker\'s Ring', 'evokers_ring' },
        ...
        { 'Summoner\'s Brcr.', 'summoners_bracers', 'summoners_brcr.' },
        { 'Summoner\'s Cape', 'summoners_cape' },
        { 'Summoner\'s Horn', 'summoners_horn' },
        { 'Summoner\'s Pgch.', 'summoners_pgch.', 'summoners_pigaches' },
        { 'Summoner\'s Spats', 'summoners_spats' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['SMN'];
...
local function equipCombatStyle(force)
    if state.Playstyle == 'Craft' and isEngaged(getPlayer()) then
        ...
        if equipNamedSet(setNameFor('AvatarPerp'), force) then
            return true;
        end
    ...
    return equipNamedSet('Playstyle_AvatarPerp', force);
end
...
local function lockstyleCombatSet()
    if not equipNamedSet('TP', true) then
        if not equipNamedSet(setNameFor('AvatarPerp'), true) then
...
profile.OnLoad = function()
    ...
    message('Configured default Subjob=WHM. Use /lac fwd subjob for level-37 capabilities.');

...
mechanicsSwapPlanner.transitions['FastCast'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Legs',
            ['itemId'] = 15126,
            ['item'] = 'Bard\'s Cannions',
            ['reason'] = 'pool delta HP+17, MP+42',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['BRD'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Oddone_29938_BRD',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Oddone_29938 BRD';

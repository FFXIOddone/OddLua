local profile = {};
profile.OddLuaBuildToken = '295EA284807ACA75561AEE210E642D53068396D160FECE10E9F16915980A6F7E';
...
local DEFAULT_PLAYSTYLE = 'Song';
local STYLE_COMMANDS_TEXT = 'song|fastcast|magicaccuracy|idlerefresh';
...
mechanicsSwapPlanner.transitions['Song'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Song',
    ['actions'] = {
        {
        ...
        },
        {
            ...
            ['slot'] = 'Head',
            ['itemId'] = 15081,
            ['item'] = 'Bard\'s Roundlet',
            ['reason'] = 'pool delta HP-2, MP-25',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
mechanicsSwapPlanner.transitions['SongPrecast'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'SongPrecast',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['SongDebuff'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'SongDebuff',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['SongBuff'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'SongBuff',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['Weaponskill'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Body',
            ['itemId'] = 15096,
            ['item'] = 'Bard\'s Jstcorps',
            ['reason'] = 'pool delta HP-1, MP-20',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'BRD',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-BRD.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Bard\'s Cannions', 'bards_cannions' },
        { 'Bard\'s Cape', 'bards_cape' },
        { 'Bard\'s Cuffs', 'bards_cuffs' },
        { 'Bard\'s Jstcorps', 'bards_jstcorps', 'bards_justaucorps' },
        { 'Bard\'s Roundlet', 'bards_roundlet' },
        { 'Baron\'s Chapeau', 'barons_chapeau' },
        { 'Battle Boots', 'battle_boots' },
        { 'Battle Horn', 'damani_horn' },
        ...
        { 'Gjallarhorn', 'gjallarhorn', 'gjallarhorn_75' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['BRD'];
...
local function equipCombatStyle(force)
    if state.Playstyle == 'Craft' and isEngaged(getPlayer()) then
        ...
        if equipNamedSet(setNameFor('Song'), force) then
            return true;
        end
    ...
    return equipNamedSet('Playstyle_Song', force);
end
...
local function lockstyleCombatSet()
    if not equipNamedSet('TP', true) then
        if not equipNamedSet(setNameFor('Song'), true) then

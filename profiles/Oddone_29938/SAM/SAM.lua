local profile = {};
profile.OddLuaBuildToken = '367C99BB4A38AF55DE20DA0DDD54CE07646B35FD4DAF94F64DFF552925BC8659';
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'SAM',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-SAM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'T.kazu Jinpachi', 't.kazu_jinpachi', 'tsukikazu_jinpachi' },

...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['BLU'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Oddone_29938_BLU',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Oddone_29938 BLU';

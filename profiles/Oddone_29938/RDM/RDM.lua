...
mechanicsSwapPlanner.transitions['Resting'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 13706,
            ['item'] = 'Ogre Gloves',
            ['reason'] = 'pool delta HPP+10, MP-11',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
            ...
            ['reason'] = 'pool delta HP-20, MP-20, MPP+1',
        },
        {
            ['key'] = 'equip_target',
            ['phase'] = 'equip_target',
...
mechanicsSwapPlanner.transitions['Elemental'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 14006,
            ['item'] = 'Zenith Mitts',
            ['reason'] = 'pool delta MP-23, CONVHPTOMP+50',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['RDM'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Oddone_29938_RDM',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Oddone_29938 RDM';
...
profile.OnLoad = function()
    ...
    message('Configured default Subjob=THF. Use /lac fwd subjob for level-37 capabilities.');
    oddLuaNumberRow.bindPalette();

local profile = {};
profile.OddLuaBuildToken = '792BC8CA5561297CFF0BA8631398D9A30785714A0DD7029C88F5C2485CF6458F';
...
local DEFAULT_PLAYSTYLE = 'Enspell';
local STYLE_COMMANDS_TEXT = 'enspell|magicaccuracy|fastcast|cure';
...
local mechanicsSwapPlanner = {
    ...
    ['explicitTransitions'] = {
        ['setmp'] = {
            ...
            ['slot'] = 'Body',
            ['sourceItem'] = 'Yigit Gomlek',
            ['bridgeItem'] = 'Dalmatica',
            ['finalItem'] = 'Blood Scale Mail',
            ['conversionAmount'] = 50,
            ['bridgeHpCost'] = 50,
            ['hpCost'] = 50,
            ['mpGain'] = 50,
...
mechanicsSwapPlanner.transitions['Enspell'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Enspell',
    ['actions'] = {
        {
        ...
        },
        {
            ...
            ['slot'] = 'Legs',
            ['itemId'] = 14218,
            ['item'] = 'Warlock\'s Tights',
            ['reason'] = 'pool delta HP-25, MP-12',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
    ...
    ['actions'] = {
        {
            ...
            ['slot'] = 'Body',
            ['itemId'] = 12642,
            ['item'] = 'Warlock\'s Tabard',
            ['reason'] = 'pool delta MP+14',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WaterRes'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Feet',
            ['itemId'] = 14093,
            ['item'] = 'Warlock\'s Boots',
            ['reason'] = 'pool delta MP+11',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['DarkRes'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['slot'] = 'Hands',
            ['itemId'] = 13965,
            ['item'] = 'Warlock\'s Gloves',
            ['reason'] = 'pool delta MP-13',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
mechanicsSwapPlanner.transitions['MagicBurst'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'MagicBurst',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
mechanicsSwapPlanner.transitions['Spikes'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 13877,
            ['item'] = 'Zenith Crown +1',
            ['reason'] = 'pool delta HP-14, MP-14, CONVHPTOMP+55',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
mechanicsSwapPlanner.transitions['Elemental'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 14006,
            ['item'] = 'Zenith Mitts',
            ['reason'] = 'pool delta MP-25, CONVHPTOMP+50',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_loss',
...
mechanicsSwapPlanner.transitions['Weaponskill'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 13706,
            ['item'] = 'Ogre Gloves',
            ['reason'] = 'pool delta HPP+10, MP-13',
        },
        {
            ['key'] = 'equip_target',
            ['phase'] = 'equip_target',
...
mechanicsSwapPlanner.transitions['WSElemental'] = {
    ...
    ['warnings'] = { 'final_hp_pool_lower', 'hp_percent_or_conversion_requires_runtime_probe', 'mp_percent_or_conversion_requires_runtime_probe' },
    ['poolSummaries'] = {
        ['HP'] = {
            ['sourceFlat'] = 69,
            ['targetFlat'] = 42,
...
local reconciliationConfig = {
    ...
    playerId = '29938',
    job = 'RDM',
    logPath = 'logs/oddlua-reconcile-Oddone_29938-RDM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Dls. Chapeau +1', 'dls._chapeau_+1', 'duelists_chapeau_+1' },
        { 'Dls. Gloves +1', 'dls._gloves_+1', 'duelists_gloves_+1' },
        { 'Dls. Tights +1', 'dls._tights_+1', 'duelists_tights_+1' },
        { 'Dst. Leggings', 'darksteel_leggings', 'dst._leggings' },
        { 'Duelist\'s Belt', 'duelists_belt' },
        { 'Duelist\'s Boots', 'duelists_boots' },
        { 'Duelist\'s Tabard', 'duelists_tabard' },
        ...
        { 'Warlock\'s Boots', 'warlocks_boots' },
        { 'Warlock\'s Gloves', 'warlocks_gloves' },
        { 'Warlock\'s Tabard', 'warlocks_tabard' },
        { 'Warlock\'s Tights', 'warlocks_tights' },
        { 'Warwolf Belt', 'warwolf_belt' },
        { 'Wilderness Earring', 'handlers_earring' },
        { 'Wlk. Chapeau +1', 'warlocks_chapeau_+1', 'wlk._chapeau_+1' },
...
local function mainJobHasNativeDualWield()
    local minimumLevel = nativeDualWieldMainJobs['RDM'];
...
local function equipCombatStyle(force)
    if state.Playstyle == 'Craft' and isEngaged(getPlayer()) then
        ...
        if equipNamedSet(setNameFor('Enspell'), force) then
            return true;
        end
    ...
    return equipNamedSet('Playstyle_Enspell', force);
end
...
local function lockstyleCombatSet()
    if not equipNamedSet('TP', true) then
        if not equipNamedSet(setNameFor('Enspell'), true) then

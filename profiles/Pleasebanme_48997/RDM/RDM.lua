local profile = {};
profile.OddLuaBuildToken = '7692AC726E93569BC7615ACD0BCFA7FCCEB7DB022AE834C7B3EFBB8FC92B40E5';
...
local function message(text)
    text = '[Pleasebanme RDM] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '48997',
    job = 'RDM',
    logPath = 'logs/oddlua-reconcile-Pleasebanme_48997-RDM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',

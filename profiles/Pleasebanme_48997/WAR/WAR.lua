local profile = {};
profile.OddLuaBuildToken = '5B9CA52FFDAD01B4251B160EA83860B1619C6294F46E0A796DAD582645E03F9F';
...
local function message(text)
    text = '[Pleasebanme WAR] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '48997',
    job = 'WAR',
    logPath = 'logs/oddlua-reconcile-Pleasebanme_48997-WAR.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        { 'Amethyst Earring', 'amethyst_earring' },
        { 'Bastokan Subligar', 'bastokan_subligar' },
        { 'Brave Belt', 'brave_belt' },
        { 'Centurion\'s Visor', 'centurions_visor' },
        { 'Courage Ring', 'courage_ring' },
        { 'Ctr. Scale Mail', 'centurions_scale_mail', 'ctr._scale_mail' },
        { 'Giant\'s Earring', 'giants_earring' },
        { 'Kupo Suit', 'kupo_suit' },
        { 'Lizard Ledelsens', 'lizard_ledelsens' },
        { 'Onion Sword', 'onion_sword' },
        { 'Peacock Charm', 'peacock_charm' },
        { 'Ryl.Sqr. Mufflers', 'royal_squires_mufflers', 'ryl.sqr._mufflers' },
        { 'San d\'Orian Ring', 'san_dorian_ring' },
        { 'Sprout Beret', 'sprout_beret' },
        { 'Tenax Strap', 'tenax_strap' },
        { 'Voulge', 'voulge' },
    },
    aliases = {},
};

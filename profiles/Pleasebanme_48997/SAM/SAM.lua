local profile = {};
profile.OddLuaBuildToken = '8D92A7F7B160B24FCBF8C1F015C1582C1278A650EBD9D85D111CE36DECFB7ADB';
...
local function message(text)
    text = '[Pleasebanme SAM] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '48997',
    job = 'SAM',
    logPath = 'logs/oddlua-reconcile-Pleasebanme_48997-SAM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Fang Earring', 'fang_earring' },
        { 'Giant\'s Earring', 'giants_earring' },
        { 'Homura', 'homura' },
        { 'Koryukagemitsu', 'koryukagemitsu' },
        { 'Kupo Suit', 'kupo_suit' },
        { 'Peacock Charm', 'peacock_charm' },
        { 'Peiste Mantle', 'peiste_mantle' },
        { 'Ryl.Kgt. Bascinet', 'royal_knights_bascinet', 'ryl.kgt._bascinet' },
        { 'Ryl.Kgt. Belt', 'royal_knights_belt', 'ryl.kgt._belt' },
        { 'Ryl.Kgt. Breeches', 'royal_knights_breeches', 'ryl.kgt._breeches' },
        { 'Ryl.Kgt. Chainmail', 'royal_knights_chainmail', 'ryl.kgt._chainmail' },
        { 'Ryl.Kgt. Mufflers', 'royal_knights_mufflers', 'ryl.kgt._mufflers' },
        { 'Ryl.Kgt. Sollerets', 'royal_knights_sollerets', 'ryl.kgt._sollerets' },
        { 'San d\'Orian Ring', 'san_dorian_ring' },
        { 'Sprout Beret', 'sprout_beret' },
        { 'Tenax Strap', 'tenax_strap' },
        { 'Win. Kyahan', 'win._kyahan', 'windurstian_kyahan' },
    },
    aliases = {},
};

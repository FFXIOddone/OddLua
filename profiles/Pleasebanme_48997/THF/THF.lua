...
local function message(text)
    text = '[Pleasebanme THF] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '48997',
    job = 'THF',
    logPath = 'logs/oddlua-reconcile-Pleasebanme_48997-THF.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Pleasebanme_48997_THF',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Pleasebanme_48997 THF';

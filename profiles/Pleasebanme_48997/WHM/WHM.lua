local profile = {};
profile.OddLuaBuildToken = '376A6D91A3B8629FC224685D3E044C0D6EE6F7E97E35715F475D41185BB95864';
...
local function message(text)
    text = '[Pleasebanme WHM] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '48997',
    job = 'WHM',
    logPath = 'logs/oddlua-reconcile-Pleasebanme_48997-WHM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',

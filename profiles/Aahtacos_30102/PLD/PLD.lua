...
local subjobs = {
    ...
    BLU = {
        ...
        abilities = {
            { name = 'burst_affinity', level = 25, recast = 120, recastId = 182, ce = 1, ve = 300 },
        },
        traits = {
        },
        spells = {
            { name = 'foot_kick', level = 1, mp = 5, cast = 500, recast = 6500 },
            { name = 'pollen', level = 1, mp = 8, cast = 2000, recast = 5000 },
            { name = 'sandspin', level = 1, mp = 10, cast = 1500, recast = 9750 },
            { name = 'power_attack', level = 4, mp = 5, cast = 500, recast = 7250 },
            { name = 'sprout_smack', level = 4, mp = 6, cast = 500, recast = 7250 },
            { name = 'wild_oats', level = 4, mp = 9, cast = 500, recast = 7250 },
            { name = 'cocoon', level = 8, mp = 10, cast = 1750, recast = 60000 },
            { name = 'metallic_body', level = 8, mp = 19, cast = 3000, recast = 60000 },
            { name = 'queasyshroom', level = 8, mp = 20, cast = 2000, recast = 15000 },
            { name = 'battle_dance', level = 12, mp = 12, cast = 1000, recast = 10000 },
            { name = 'feather_storm', level = 12, mp = 12, cast = 500, recast = 10000 },
            { name = 'head_butt', level = 12, mp = 12, cast = 500, recast = 10000 },
            { name = 'healing_breeze', level = 16, mp = 55, cast = 4500, recast = 15000 },
            { name = 'helldive', level = 16, mp = 16, cast = 500, recast = 11250 },
            { name = 'sheep_song', level = 16, mp = 22, cast = 3000, recast = 60000 },
            { name = 'blastbomb', level = 18, mp = 36, cast = 2250, recast = 15000 },
            { name = 'bludgeon', level = 18, mp = 16, cast = 500, recast = 11750 },
            { name = 'cursed_sphere', level = 18, mp = 36, cast = 3000, recast = 19500 },
            { name = 'blood_drain', level = 20, mp = 10, cast = 4000, recast = 26000 },
            { name = 'claw_cyclone', level = 20, mp = 24, cast = 1000, recast = 19750 },
            { name = 'poison_breath', level = 22, mp = 22, cast = 3000, recast = 19500 },
            { name = 'soporific', level = 24, mp = 38, cast = 3000, recast = 26000 },
            { name = 'screwdriver', level = 26, mp = 21, cast = 500, recast = 14000 },
            { name = 'bomb_toss', level = 28, mp = 42, cast = 3750, recast = 24500 },
            { name = 'grand_slam', level = 30, mp = 24, cast = 1000, recast = 14250 },
            { name = 'wild_carrot', level = 30, mp = 37, cast = 2500, recast = 6000 },
            { name = 'chaotic_eye', level = 32, mp = 13, cast = 3000, recast = 10000 },
            { name = 'sound_blast', level = 32, mp = 25, cast = 4000, recast = 30000 },
            { name = 'death_ray', level = 34, mp = 49, cast = 4500, recast = 29250 },
            { name = 'smite_of_rage', level = 34, mp = 28, cast = 500, recast = 13000 },
            { name = 'digest', level = 36, mp = 20, cast = 4000, recast = 26000 },
...
mechanicsSwapPlanner.transitions['Tank'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Tank',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['MagicDefense'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'MagicDefense',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WS_Swift_Blade'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WS_Swift_Blade',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WSAcc_Swift_Blade'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WSAcc_Swift_Blade',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WS_Sickle_Moon'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WS_Sickle_Moon',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WSAcc_Sickle_Moon'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WSAcc_Sickle_Moon',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WS_Spinning_Slash'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WS_Spinning_Slash',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WSAcc_Spinning_Slash'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'WSAcc_Spinning_Slash',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
local weaponSkillRoutes = {
    ...
    ['sickle_moon'] = 'WS_Sickle_Moon',
    ['skullbreaker'] = 'WS_Skullbreaker',
    ['spinning_slash'] = 'WS_Spinning_Slash',
...
local weaponSkillAccuracyRoutes = {
    ...
    ['sickle_moon'] = 'WSAcc_Sickle_Moon',
    ['skullbreaker'] = 'WSAcc_Skullbreaker',
    ['spinning_slash'] = 'WSAcc_Spinning_Slash',
...
local reconciliationConfig = {
    ...
    playerId = '30102',
    job = 'PLD',
    logPath = 'logs/oddlua-reconcile-Aahtacos_30102-PLD.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
local function equipCombatStyle(force)
    if state.Playstyle == 'Craft' and isEngaged(getPlayer()) then
        ...
        if equipNamedSet(setNameFor('Tank'), force) then
            return true;
        end
...
local function lockstyleCombatSet()
    if not equipNamedSet('TP', true) then
        if not equipNamedSet(setNameFor('Tank'), true) then

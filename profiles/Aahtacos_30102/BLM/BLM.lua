local profile = {};
profile.OddLuaBuildToken = 'C3CC06675A2F20D54133DCB751BAC0327A016F65941A0824F89727A8A2C8008E';
...
local function message(text)
    text = '[Aahtacos BLM] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '30102',
    job = 'BLM',
    logPath = 'logs/oddlua-reconcile-Aahtacos_30102-BLM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',

...
profile.OnLoad = function()
    ...
    message('OddLua dynamic profile loaded for Aahtacos_30102. Default combat style: ' .. state.Playstyle .. '. Use /lac fwd style nuke|magicaccuracy|fastcast|idlerefresh.');

...
local setRequiresDualWieldSub = {
    ...
    Weather_Earth = true,
    Day_Earth = true,
    Elemental_Thunder = true,
    Weather_Thunder = true,
    Day_Thunder = true,
    Elemental_Lightning = true,
    Weather_Lightning = true,
    Day_Lightning = true,
    Elemental_Water = true,
    Weather_Water = true,
    Day_Water = true,
    Elemental_Light = true,
    Weather_Light = true,
    Day_Light = true,
    Elemental_Dark = true,
    Weather_Dark = true,
...
local function mainJobHasNativeDualWield()
    return nativeDualWieldMainJobs['NIN'] == true;
end
...
local oddLuaNumberRow = {
    renderEvent = 'oddlua_number_row_Aahtacos_30102_NIN',
    imgui = nil,
...
function oddLuaNumberRow.renderOverlay()
    ...
    local title = 'OddLua Aahtacos_30102 NIN';

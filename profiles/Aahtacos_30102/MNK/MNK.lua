local profile = {};
profile.OddLuaBuildToken = 'ECC88EA67F5AC331A82A13D08FA6EFC7FE3C30F77F63902770378E6BD89A8150';
    ...
    Playstyle_Evasion = {
        {
            ...
            afterUse = { Feet = 'Suzaku\'s Sune-Ate' },
            item = {
                ['id'] = 15754,
...
mechanicsSwapPlanner.transitions['Chakra'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Chakra',
    ['actions'] = {
        {
...
mechanicsSwapPlanner.transitions['Counterstance'] = {
    ['sourceSet'] = 'Aftercast',
    ['targetSet'] = 'Counterstance',
    ['actions'] = {
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_gain',
...
mechanicsSwapPlanner.transitions['WS_Combo'] = {
    ...
    ['actions'] = {
        ...
        },
        {
            ...
            ['itemId'] = 15073,
            ['item'] = 'Melee Crown',
            ['reason'] = 'pool delta HP-50, HPP+5, MP-50',
        },
        {
            ['key'] = 'equip_target',
            ['phase'] = 'equip_target',
...
local function message(text)
    text = '[Aahtacos MNK] ' .. tostring(text or '');
...
local reconciliationConfig = {
    ...
    playerId = '30102',
    job = 'MNK',
    logPath = 'logs/oddlua-reconcile-Aahtacos_30102-MNK.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Aquarius Subligar', 'aquarius_subligar' },
        ...
        { 'Mana Ring', 'mana_ring' },
        { 'Martial Knuckles', 'martial_knuckles' },
        { 'Melee Cape', 'melee_cape' },
        { 'Melee Crown', 'melee_crown' },
        { 'Melee Cyclas', 'melee_cyclas' },
        { 'Melee Gaiters', 'melee_gaiters' },
        { 'Melee Gloves', 'melee_gloves' },
        { 'Melee Hose', 'melee_hose' },

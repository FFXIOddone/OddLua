local profile = {};
profile.OddLuaBuildToken = '88F7708082FC8791682DE57EEEF25E68122EFC146202C8C73D5C84D1B3D2BBC0';
    ...
    ['actions'] = {
        {
            ...
            ['itemId'] = 14651,
            ['item'] = 'Mana Ring',
            ['reason'] = 'pool delta MP+15, MPP+15',
        },
        {
            ['key'] = 'pool_bridge_transition',
            ['phase'] = 'equip_pool_mixed',
...
local reconciliationConfig = {
    ...
    playerId = '30102',
    job = 'RDM',
    logPath = 'logs/oddlua-reconcile-Aahtacos_30102-RDM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Duelist\'s Chapeau', 'duelists_chapeau' },

local profile = {};
profile.OddLuaBuildToken = '60CB69F83DAE8C8EB78DB9381DA4D78EB6D0735553AF2433B216C7F4D22C3BAE';
    ...
    Idle = {
        {
            condition = { type = 'missing_status', name = 'quickening', buffs = { 'quickening', 176 } },
            slots = { Feet = 'Sprinter\'s Shoes' },
            afterUse = { Feet = 'Fisherman\'s Boots' },
            item = {
                ['id'] = 15754,
                ['name'] = 'Sprinter\'s Shoes',
                ['effect'] = 'quickening',
...
local reconciliationConfig = {
    ...
    playerId = '30102',
    job = 'WHM',
    logPath = 'logs/oddlua-reconcile-Aahtacos_30102-WHM.jsonl',
    slotOrder = {
    'Main',
    'Sub',
    'Range',
...
profile.ReconciliationNameAliases = {
    groups = {
        ...
        { 'Field Tunica', 'field_tunica' },
        { 'Fisherman\'s Boots', 'fishermans_boots' },
        { 'Galkan Braguette', 'galkan_braguette' },
        { 'Kupo Suit', 'kupo_suit' },
